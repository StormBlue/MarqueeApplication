...
public class ShimmerMarqueeLayout extends FrameLayout {
    ...
    public ShimmerMarqueeLayout(Context context) {
        this(context, null, 0);
    }

    public ShimmerMarqueeLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ShimmerMarqueeLayout(Context context, AttributeSet attrs, int defStyle) {
...
//        renderCanvas.drawColor(Color.WHITE);
    ...
    private Bitmap getMaskBitmap() {
        ...
        Log.d(TAG, "getMaskBitmap()---width:" + width + ";height:" + height);
