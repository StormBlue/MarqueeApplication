...
//        Log.d(TAG, "onDraw");
    ...
    public AnimatorSet getAnimatorSet() {
        ...
        mAnimatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                Log.d(TAG, "mAnimatorSet---onAnimationStart");
            }

            @Override
            public void onAnimationEnd(Animator animation) {
                Log.d(TAG, "mAnimatorSet---onAnimationEnd");
                mProgressAnimationFinished = false;
                mNullAnimationFinished = false;
            }
            ...
            public void onAnimationCancel(Animator animation) {
                Log.d(TAG, "mAnimatorSet---onAnimationCancel");
            }
    ...
    private Animator getShimmerAnimation() {
        ...
        mShimmerAnimator.addListener(new Animator.AnimatorListener() {
            @Override
            public void onAnimationStart(Animator animation) {
